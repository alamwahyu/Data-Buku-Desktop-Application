...
public class bag_buku extends JFrame implements ActionListener{
...
public final void setJam(){
    ...
    public bag_buku(){
        ...
        btn_refresh.setBounds(400,525,80,75);
        ...
        btn_tambah.setText("");
        btn_tambah.setFont(new Font("Tahoma", Font.BOLD,14));
        btn_tambah.setBounds(73,535,70,60);
        ...
        btn_tambah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/tmb.png")));
        btn_tambah.setForeground(new java.awt.Color(0, 0, 255));
        this.getContentPane().add(btn_tambah);
        
        btn_ubah.setText("");
        btn_ubah.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btn_ubah.setBackground(new java.awt.Color(153,255,255));
        btn_ubah.setFont(new Font("Tahoma", Font.BOLD,14));
        btn_ubah.setBounds(185,535, 70,55);
        btn_ubah.setForeground(new java.awt.Color(0, 0, 255));
        btn_ubah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/ubh.png")));
        this.getContentPane().add(btn_ubah);
        ...
        btn_hapus.setBounds(293,535,70,55);
        btn_hapus.setForeground(new java.awt.Color(0, 0, 255));
        btn_hapus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/hps.png")));
    ...
    private void userInterface(){
        getContentPane().add(new bg("../image/yoi.png"));
    }
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource().equals(btn_tambah)){
        ...
        if(ae.getSource().equals(btn_ubah)){
            bag_ubah frm = new bag_ubah();
            frm.addWindowListener(new WindowAdapter(){
                public void windowClosing(WindowEvent e){
                    ((Component) currentWindow).setEnabled(true);
                }
