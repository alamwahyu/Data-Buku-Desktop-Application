...
public class bag_ubah extends JFrame implements ActionListener{
    ...
    public bag_ubah(){
       ...
       biru.setIcon(new javax.swing.ImageIcon(getClass().getResource("../image/ubah.png")));
       biru.setBounds(-10, -30, 370, 400);
        ...
        txt_judul.setForeground(new java.awt.Color(255, 255, 255));
          txt_judul.setBackground(new java.awt.Color(0, 102, 153));
        ...
        txt_np1.setText("");
          txt_np1.setBackground(new java.awt.Color(0, 102, 153));
        ...
        txt_np2.setText("");
        txt_np2.setBackground(new java.awt.Color(0, 102, 153));
        ...
        txt_tahun.setText("");
        txt_tahun.setBackground(new java.awt.Color(0, 102, 153));
        ...
        txt_penerbit.setBackground(new java.awt.Color(0, 102, 153));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource().equals(btn_save)){
            ...
            if(cek.equals("valid")){
                String simpan = new class_buku().ubah_data(isbn+" - "+isbn1+" - "+isbn2+" - "+isbn3+" - "+isbn4, judul, nama_pengarang1, nama_pengarang2, tahun, penerbit);
